...
| ▓▓  | ▓▓ ▓▓   \▓▓▓  |  \   \▓▓▓  |   ▓▓ \ ▓▓  \▓ | ▓▓
 \▓▓   \▓▓\▓▓    \▓    \▓▓    \▓    \▓▓▓▓▓▓\▓▓      \▓▓
  ...
  keys = {
    ...
    --{ "<leader>uC", function() require("config.theme").switch_theme() end, desc = "Colorschemes" },
    -- LSP
    ...
    { "<leader>tv", "<cmd>ToggleTerm size=70 direction=vertical<cr>", desc = "Open Vertical Terminal" },
    ...
    -- Split windows and window navigation
    { "<leader>vs", "<cmd>vsplit<cr>", desc = "Vertical Split" },
    { "<leader>hs", "<cmd>split<cr>", desc = "Horizontal Split" },
    { "<C-h>", "<C-w>h", desc = "Navigate Window Left" },
    { "<C-j>", "<C-w>j", desc = "Navigate Window Down" },
    { "<C-k>", "<C-w>k", desc = "Navigate Window Up" },
    { "<C-l>", "<C-w>l", desc = "Navigate Window Right" },
    -- Neovim News
    {
      "<leader>N",
      desc = "Neovim News",
